...
<head>
	...
	<title>Gokhale Recruitment System - <?php echo "$compname"; ?></title>
				...
				<div class="container">
					...
					<div class="row">
							...
							<div class="col-md-10 col-md-offset-1">
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#337fcb; color:white" '; } ?>  href="company.php?ref=<?php echo "$company_id"; ?>&page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
