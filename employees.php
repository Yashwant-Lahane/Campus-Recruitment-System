...
<head>
	...
	<title>Gokhale Recruitment System - Student</title>
						...
						<div class="GridLex-gap-15-wrappper">
                            ...
                            $total_records++;
	                        ...
	                        }catch(PDOException $e)
                             {
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#337fcb; color:white" '; } ?>  href="employees.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
