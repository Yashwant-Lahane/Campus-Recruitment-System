...
<head>
	...
	<title>Gokhale Recruitment System - Company</title>
						...
						<div class="GridLex-gap-30">
                            ...
                            $total_records++;
	                        ...
	                        }catch(PDOException $e)
                             {
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#337fcb; color:white" '; } ?>  href="employers.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="employers.php">Compnay</a></li>
