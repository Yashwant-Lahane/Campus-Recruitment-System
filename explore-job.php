...
<head>
	...
	<title>Gokhale Recruitment System - <?php echo "$jobtitle"; ?></title>
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="job-detail-wrapper">
								...
								if ($myrole == "employee") {
									...
									print '<br><button onclick="redirectOnlineAssessment()" value="'.$jobid.'" class="btn btn-primary btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-pencil"></i> Give Online Assessment</button>';
								}else{
								...
								print '<br><button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Login to Give Online Assesment</button>';	
...
<script>
function redirectOnlineAssessment(jobId) {
    var confirmation = window.confirm("Are you sure you want to give the online assessment?");
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Gokhale Recruitment System</h5>
											<p>Gokhale Recruitment System is a job portal, online job management system developed by Gokhale College Students for his project in february 2018.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Gokhale Recruitment System Contact</h5>
								
								<p>Address : 2Q35+QHV, Krishi Nagar, Nashik, Maharashtra 422005</p>
								<p>Email : <a href="mailto:gokhalerecruitment@gmail.com">gokhalerecruitment@gmail.com</a></p>
								<p>Phone : <a href="tel:+233546607474">0253 257 0106</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Gokhale Recruitment System</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Gokhale College Students</a></li>
								</ul>
